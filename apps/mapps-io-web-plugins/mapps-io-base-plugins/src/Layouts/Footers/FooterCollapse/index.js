...
const FooterCollapseMobileRender = (props) => {
    ...
    return (
        <React.Fragment>
            <Grid ref={anchorRef} container style={{ justifyContent: "center", height: "48px" }}>
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(FooterCollapseMobileRender));
