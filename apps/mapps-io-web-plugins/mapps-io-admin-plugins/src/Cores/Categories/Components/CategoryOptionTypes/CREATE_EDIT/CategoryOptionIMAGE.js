...
class CategoryOptionIMAGE extends CategoryOptionBase {
  constructor(props) {
    super(props);
    this.state = {};
    ...
    if (
      ...
      props.addEmptyElementOption(uuid(), this.state.catOption.id, 1, "GUID");
      props.addEmptyElementOption(uuid(), this.state.catOption.id, 2, "Jest główne");
    }
...
export default connect(mapStateToProps, mapDispatchToProps)(withRouter(CategoryOptionIMAGE));
