...
import CategoryOptionSelectSingle from "./CategoryOptionSELECT_SINGLE";
import CategoryOptionBase from "./CategoryOptionBase";
import { withRouter } from "react-router-dom";

class CategoryOptionSELECT extends CategoryOptionBase {
    constructor(props) {
        super(props);
        this.state = {};
        ...
        if (!this.state.catOption.cat_opt_temp) {
            this.props.addEmptyElementOption(uuid(), this.state.catOption.id, 1, "NEW OPTION");
        }
...
export default connect(mapStateToProps, mapDispatchToProps)(withRouter(CategoryOptionSELECT));
