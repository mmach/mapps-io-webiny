...
class CategoryOptionSingleDependency extends CategoryOptionBase {
  constructor(props) {
    super(props);
    this.state = {};
    ...
    if (
      ...
      this.props.addEmptyElementOption(uuid(), this.state.catOption.id, 1, "VALUE");
      this.props.addEmptyElementOption(uuid(), this.state.catOption.id, 2, "DEP_1");
      this.props.addEmptyElementOption(uuid(), this.state.catOption.id, 3, "DEP_2");
    }
  }
...
export default connect(
  mapStateToProps,
  mapDispatchToProps
)(withRouter(CategoryOptionSingleDependency));
