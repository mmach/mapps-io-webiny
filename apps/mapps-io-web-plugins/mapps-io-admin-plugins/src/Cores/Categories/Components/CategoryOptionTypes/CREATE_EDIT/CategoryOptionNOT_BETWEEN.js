...
class CategoryOptionNotBetween extends CategoryOptionBase {
  constructor(props) {
    super(props);
    this.state = {};
    ...
    if (
      ...
      this.props.addEmptyElementOption(uuid(), this.state.catOption.id, 1, "START DATE");
      this.props.addEmptyElementOption(uuid(), this.state.catOption.id, 2, "END DATE");
    }
  }
...
export default connect(mapStateToProps, mapDispatchToProps)(withRouter(CategoryOptionNotBetween));
