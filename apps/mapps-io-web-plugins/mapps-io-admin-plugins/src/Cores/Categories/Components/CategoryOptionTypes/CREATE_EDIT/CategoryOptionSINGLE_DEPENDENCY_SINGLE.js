...
class CategoryOptionSingleDependencySingle extends React.Component {
  constructor(props) {
    super(props);
    this.state = {};
            ...
            <Grid key={i} container item xs="12">
              <Grid item xs="8">
                <TextBox
                  ...
                  value={this.state.catOption[`placeholder_${i}`]}
                  onChange={(event) => {
                    this.refreshValidation.bind(this)();
                    const catOption = { ...this.state.catOption };
                    catOption[`placeholder_${i}`] = event.target.value;
                    this.setState({
                      catOption: catOption
                    });
                  }}
...
export default connect(mapStateToProps, mapDispatchToProps)(CategoryOptionSingleDependencySingle);
